    ...
    public function widget($args, $instance)
    {
        ...
        <div class="w4p-aboutme clearfix">
			...
			<div>            
				...
				<?php if (!empty($instance['facebook']) || !empty($instance['twitter']) || !empty($instance['linkedin']) || !empty($instance['google']) || !empty($instance['flickr'])
							|| !empty($instance['feedburner']) || !empty($instance['youtube']) || !empty($instance['skype']) || !empty($instance['lastfm']) || !empty($instance['instagram'])
							|| !empty($instance['deviantart']) || !empty($instance['pinterest'])) :?>
